...
def test_AnalysisExplorer(get_path):
    ...
    all_options_dict = {
        get_path + "IMG_2809.png": "IMG_2809",
        get_path + "IMG_2746.png": "IMG_2746",
    }
    ...
    analysis_explorer_faces.update_picture(get_path + "IMG_2809.png")
    analysis_explorer_objects.update_picture(get_path + "IMG_2746.png")

    assert analysis_explorer_objects.update_picture(None) is None

    analysis_explorer_faces._right_output_analysis(
        None, ["something", "faces"], all_options_dict, get_path + "IMG_2809.png"
    )
    analysis_explorer_objects._right_output_analysis(
        None, ["something", "objects"], all_options_dict, get_path + "IMG_2746.png"
    )
